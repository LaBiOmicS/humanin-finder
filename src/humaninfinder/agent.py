...
class HumaninAgent:
    ...
    def analyze_results(self, csv_path, query=None):
        ...
        - Evolutionarily, HN is subject to "evolutionary tuning"—sequence variations often correlate
          with species-specific lifespans and metabolic rates.
        - Pseudogenic relics (loci with internal stops) are genomic "ghosts" that still hold
          structural information about ancient MDPs.
        ...
        if query:
            ...
            full_prompt = (
                f"{context}\n\nPlease summarize the biological significance of these findings, "
                "focusing on evolutionary conservation and potential functional relics (pseudogenes)."
            )
